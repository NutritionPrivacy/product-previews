...
final class ChunkedFileWriterTests: XCTestCase {
    ...
    override func setUpWithError() throws {
		...
		testUnit = ChunkedFileWriter(name: defaultName, fileExtension: defaultFileExtension, directory: tmpDirectory, maxPartSize: 10 * 1024 * 1024)
    }
	...
	func test_write_moreThanMaxPartSize_createsMultipleFiles() throws {
		...
		testUnit = ChunkedFileWriter(name: defaultName, fileExtension: defaultFileExtension, directory: tmpDirectory, maxPartSize: 10)
